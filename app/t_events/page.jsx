        ...
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#fdf6e3] dark:bg-[#0f172a]">
            ...
            >
                ...
                <form onSubmit={handleCreateEvent} className="space-y-6">
                    {step === 1 && (
                        <>
                            <InputField icon="🏷️" label="Title" value={title} onChange={setTitle} />
                            <InputField icon="🆔" label="NGO ID" value={ngoId} onChange={setNgoId} />
                    ...
                    {step === 2 && (
                        <>
                            <InputField icon="⏰" label="Start Time" value={startTime} onChange={setStartTime} type="datetime-local" />
                            <InputField icon="🔚" label="End Time" value={endTime} onChange={setEndTime} type="datetime-local" />
                            <InputField icon="📅" label="Google Calendar Event ID" value={googleEventId} onChange={setGoogleEventId} />
                            <InputField icon="🖼️" label="Start Photo URL" value={startPhotoUrl} onChange={setStartPhotoUrl} />
                            <InputField icon="🖼️" label="End Photo URL" value={endPhotoUrl} onChange={setEndPhotoUrl} />
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Mark as Completed</label>
                            </div>
                ...
                <p className="text-center text-sm text-gray-600 dark:text-gray-400">
                    Want to go back?{" "}
                    <a href="/" className="text-yellow-600 hover:text-yellow-700 font-medium dark:text-blue-400 dark:hover:text-blue-500">
                        Go to Dashboard
                    </a>
                </p>
            </motion.div>
