        ...
        <nav className="bg-gradient-to-r from-yellow-600 to-yellow-800 dark:from-blue-500 dark:to-purple-500 p-4 shadow-lg">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <a href="/register" className="text-white hover:text-yellow-300 dark:hover:text-blue-300">
                        Register
                    </a>
                    <a href="/login" className="text-white hover:text-yellow-300 dark:hover:text-blue-300">
                        Login
                    </a>
