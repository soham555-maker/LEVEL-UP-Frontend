...
const upcomingEvents = [
  {
    ...
    description:
      "Join us for an evening of celebration and fundraising for our education initiatives.",
  },
  {
    ...
    description:
      "Learn essential skills to make a difference in your community.",
  },
];
...
const testimonials = [
  {
    quote:
      "Working with this organization changed my perspective on what community service can achieve.",
    author: "Maya P., Volunteer since 2023",
    image: "/images/testimonial1.jpg",
  },
  {
    quote:
      "The support we received helped our village overcome challenges we've faced for generations.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-yellow-100 dark:from-[#1a1a2e] dark:via-[#1a1a2e] dark:to-[#1a1a2e] text-gray-800 dark:text-gray-100">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-8 py-20 max-w-7xl mx-auto gap-10">
        <div className="flex-1">
          ...
          >
            Join our community of changemakers dedicated to creating lasting
          ...
          >
            <Link
              href="/volunteer"
              className="px-8 py-3 bg-yellow-600 hover:bg-yellow-700 text-white font-bold rounded-full transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Volunteer Now
            </Link>
            <Link
              href="/donate"
              className="px-8 py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-full transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Donate
            </Link>
          </motion.div>
      ...
      <div className="py-12 bg-yellow-600 dark:bg-purple-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl">
            To create sustainable solutions that empower communities to thrive
            independently while preserving their cultural heritage and natural
            resources.
          </p>
        </div>
      </div>
      ...
      <div className="py-20 px-6 bg-gradient-to-br from-yellow-100 to-orange-200 dark:from-gray-800 dark:to-gray-900 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center mb-12 max-w-2xl mx-auto text-gray-700 dark:text-gray-300">
            Real stories of transformation and hope from communities we've
